...
A slab is a component of the construction that may enclose a space horizontally. The slab may provide the lower support (floor) or upper construction (roof slab) in any space in a building.
